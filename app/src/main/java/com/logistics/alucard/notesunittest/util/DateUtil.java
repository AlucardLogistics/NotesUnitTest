package com.logistics.alucard.notesunittest.util;
...
public class DateUtil {
    ...
    public static String getCurrentTimeStamp() throws Exception{
        try {
            SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_FORMAT, Locale.US); //MUST USE LOWERCASE 'y'. API 23- can't use uppercase
